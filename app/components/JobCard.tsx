...
export default function JobCard({ job }: Props) {
  return (
    <div className="w-full md:w-[calc(50%-1rem)] lg:w-[calc(24.333%-1rem)] h-[600px] mx-2 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between">
